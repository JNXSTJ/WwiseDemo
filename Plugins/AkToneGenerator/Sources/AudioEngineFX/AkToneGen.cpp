...
AK_ATTR_USED AK::PluginRegistration AkToneSourceRegistration(AkPluginTypeSource, 0, 102, AkCreateToneSource, AkCreateToneSourceParams);
						  ...
						  )
{
	...
	{
		// Set up the rng seed
		m_uSeedVal = AK_GET_PLUGIN_SERVICE_RNG(in_pSourceFXContext->GlobalContext())->CreateRNG().Random();
